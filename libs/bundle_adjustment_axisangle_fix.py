...
class BundleAdjustmentAxisAngle:
    ...
    def projection(self, r_t):
        ...
        Parameters:
        - r_t: Either a axis_angle + translation (6 elements) or an extrinsic matrix (3x4).
    ...
    def pack_parameters(self):
        ...
        Converts each camera's extrinsic matrix into axis-angle and translation vector,
    ...
    def combine_fixpoint(self, params, params_fix):
        ...
        """
        num_camera_params = len(self.extrinsics) * 6  # 6 params per camera: 3 for rotation (axis-angle), 3 for translation
    ...
    def separate_fixpoints(self, all_params):
        ...
        """
        num_camera_params = len(self.extrinsics) * 6  # 6 params per camera
    ...
    def build_bundle_adjustment_sparsity(self):
        ...
        n = self.num_cameras * 6 +  (self.num_points - 50) * 3
